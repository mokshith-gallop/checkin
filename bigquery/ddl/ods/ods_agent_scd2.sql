-- bigquery/ddl/ods/ods_agent_scd2.sql
...
--   - Surrogate key agent_history_id is STRING — generated via
--     TO_HEX(MD5(CONCAT(CAST(agent_id AS STRING), '|', CAST(eff_from_ts AS STRING)))).
